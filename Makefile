...
uninstall:
	...
	@printf "\n"
	@Rscript -e 'tryCatch(remove.packages("ambience"), error = function(e) {})'

### ** clean

## clean : delete all files and folders generated during the building process
.PHONY: clean
clean: clean-man clean-data clean-vignettes clean-docs clean-compiled
	@printf "\n"
